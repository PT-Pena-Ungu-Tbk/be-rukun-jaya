...
async function main() {
  ...
  await prisma.product.createMany({
    data: [
      {
        sku_code: 'PIP-WVN-05',
        name: 'Pipa PVC Wavin 1/2 Inch',
        category_id: catPipa.id,
        supplier_id: supWavin.id,
        buy_price: 15000,
        sell_price: 18000,
        current_stock: 300,
        defective_stock: 2,
        min_stock: 50,
        rack_location: 'R-C1-01',
      },
      {
        sku_code: 'PIP-WVN-10',
        ...
        defective_stock: 0,
        min_stock: 30,
        rack_location: 'R-C1-02',
      },
      {
        sku_code: 'LEM-ISP-01',
        name: 'Lem Pipa PVC Isarplas 45g',
        category_id: catPipa.id,
        supplier_id: supWavin.id,
        buy_price: 8000,
        sell_price: 12000,
      ...
      },
      {
        ...
        defective_stock: 0,
        min_stock: 100,
        rack_location: 'R-A1-03',
      },
      {
        sku_code: 'CAT-VGL-01',
        name: 'Cat Minyak Dulux V-Gloss 1kg',
        category_id: catCat.id,
        supplier_id: supDulux.id,
        buy_price: 45000,
        sell_price: 55000,
        ...
        defective_stock: 0,
        min_stock: 15,
        rack_location: 'R-B3-01',
      },
      {
        sku_code: 'KUS-ETN-02',
        name: 'Kuas Cat Eterna 2 Inch',
        category_id: catCat.id,
        supplier_id: supDulux.id,
        buy_price: 7000,
        sell_price: 10000,
        ...
        defective_stock: 1,
        min_stock: 50,
        rack_location: 'R-B4-01',
      },
      {
        sku_code: 'THN-SPL-01',
        name: 'Thinner A Spesial 1 Liter',
        category_id: catCat.id,
        supplier_id: supDulux.id,
        buy_price: 25000,
        sell_price: 32000,
        ...
        defective_stock: 0,
        min_stock: 20,
        rack_location: 'R-B4-02',
      }
    ]
  });
  console.log('✅ 10 Products berhasil dibuat');
